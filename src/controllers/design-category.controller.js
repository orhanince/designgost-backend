 ...
 * @typedef {object} DesignCategory
 * @property {string} design_category_id - DesignCategory id (UUID)
 ...
 * @property {number} count - Total design category count
 * @property {array<Podcast>} count - DesignCategory list
 */
